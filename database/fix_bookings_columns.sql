...
-- 3. Make total_days nullable or set default if it has NOT NULL constraint
DO $$
DECLARE
...
-- 4. Update existing records to calculate total_days
...
-- 5. Update existing records to set price_per_day
UPDATE public.bookings 
